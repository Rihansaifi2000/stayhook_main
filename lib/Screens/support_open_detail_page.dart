...
class SupportOpenDetailsPage extends StatefulWidget {
  final String device;
  const SupportOpenDetailsPage({super.key, required this.device});

  @override
  State<SupportOpenDetailsPage> createState() => _SupportOpenDetailsPageState();
}

class _SupportOpenDetailsPageState extends State<SupportOpenDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>TicketActionScreen(device: 'device')));
        },
      ),
