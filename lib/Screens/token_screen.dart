...
class _TokenScreenState extends State<TokenScreen> {
  ...
  var Mode;
  List worktype = ["Leakage","Change Tabs","Pipe Fitting"," Sink Repair","Washroom Leakage"];
  var WorkType;
        ...
        actions: [
          Padding(
            ...
            child: GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>MoveInScreen(device: 'device')));
              },
              child: Container(
                                  ...
                                  contentsBuilder: (context, index) => Card(
                                    ...
                                    child: Padding(
                                      ...
                                      child: ListTile(
                                        title: RichText(
                                          text: TextSpan(
                                              text: 'Rahul Create Furnishing Work: ',
                                              style: GoogleFonts.roboto(
                                                color: Colors.blue,
                                                fontSize: 15,
                                                fontWeight:
