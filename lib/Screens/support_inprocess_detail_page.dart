...
class SupportInprocessDetailsPage extends StatefulWidget {
  final String device;

  const SupportInprocessDetailsPage({super.key, required this.device});

  @override
  State<SupportInprocessDetailsPage> createState() => _SupportInprocessDetailsPageState();
}

class _SupportInprocessDetailsPageState extends State<SupportInprocessDetailsPage> {
